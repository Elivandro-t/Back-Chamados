...
import br.com.Initialiizr.Informatica116.domain.repository.RefreshToeknRepository;
...
public class RefeshTokenService {
    ...
    public RefreshToken registrarToken(long userId) {
        ...
        refreshToken.setExpirationtime(new Date(System.currentTimeMillis() +  1000 * 60 * 60 * 4));
